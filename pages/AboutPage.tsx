...
import { SHORT_LEAGUE_NAME, LEAGUE_NAME } from '../constants';

const AboutPage: React.FC = () => {
  return (
    <div className="bg-dark-card p-6 md:p-8 rounded-xl shadow-lg border border-dark-border">
      <PageTitle title={`About ${LEAGUE_NAME}`} subtitle="Bowling Green's premier destination for competitive and recreational futsal."/>
      
      <div className="prose prose-lg lg:prose-xl max-w-5xl mx-auto">
        <p>
          Welcome to the {LEAGUE_NAME} ({SHORT_LEAGUE_NAME}), your central hub for the beautiful game in its fast-paced indoor format! 
        ...
        <p>
          {SHORT_LEAGUE_NAME} typically runs two main seasons each year: a Spring season and a Winter season. To accommodate varying levels of play, we offer two divisions:
        </p>
        <ul>
        ...
        <p>
          Beyond the games, {SHORT_LEAGUE_NAME} is about building a community. We encourage camaraderie among players, teams, and fans. We are proud to be a part of Bowling Green's vibrant sports scene and look forward to growing the futsal family here.
        </p>
